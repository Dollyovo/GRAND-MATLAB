...
% 'ORBGRAND1line' (soft detection);
DECODER='ORBGRAND1line';
...
if n-k>16
    ...
    disp(['GRAND algorithms find an erroneous decoding after ' ...
        'approximately 2^{n-k} code-book queries'])
    disp('and hence 2^{n-k} is an upper bound on complexity in terms of query numbers.')
